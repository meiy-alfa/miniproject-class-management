...
<form action="<?= site_url($target_url) ?>" method="POST">
    <div class="col-sm-12 col-md-6">
        <div class="form-group">
            <label for="student-id">Siswa</label>
            <div class="input-group mb-3">
                <select class="form-control" id="student-id" name="student_id">
                    <option value=""></option>
        ...
        <div class="form-group">
            <label for="vocation-id">Kompetensi-Rombel</label>
            <div class="input-group mb-3">
                <select class="form-control" id="vocation-id" name="vocation_id">
                    <option value=""></option>
        ...
        <div class="form-group">
            <label for="team-id">Angkatan</label>
            <div class="input-group mb-3">
                <select class="form-control" id="team-id" name="team_id">
                    <option value=""></option>
